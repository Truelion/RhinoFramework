...
namespace("core.ui.Element", {
	...
	getAttributeNode : function(){
		throw new Error(this.namespace + "#getAttributeNode() not yet implemented");
	},
	
	setAttributeNode : function(){
		throw new Error(this.namespace + "#setAttributeNode() not yet implemented");
	},
	
	removeAttributeNode : function(){
		throw new Error(this.namespace + "#removeAttributeNode() not yet implemented");
	},
	...
	normalize : function(){
		throw new Error(this.namespace + "#normalize() not yet implemented");
	},
